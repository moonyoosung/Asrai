...
public class EnemyMove_before : MonoBehaviour
{
    PlayerMove pm;
    #region "에너미 상태"
    // 에너미 상태는
    ...
    public void OnBlockHit()
    {
        ...
        //currentTime += Time.deltaTime;
        //print(currentTime);
        //if (currentTime > OnBlockTime)
        //{
        //    //// 시간초기화
        //currentTime = 0;

        a = UnityEngine.Random.Range(0, 1);
        // blockAfterNum을 0 ~ 100 중에 선택하고
        blockAfterNum = UnityEngine.Random.Range(0, 100);
        //// Block 애니메이션을 틀고
        //anim.SetTrigger("Block");

        //anim.SetFloat("BlockType", a);
        // 상태를 Block으로 전환한다. 
    ...
    public void OnHit(Vector3 hitpos)
    {
        ...
        //// Pos랜덤값
        //getHitPos = UnityEngine.Random.Range(0, 100);
        //blockPos = UnityEngine.Random.Range(0, 100);
        //parryingPos = UnityEngine.Random.Range(0, 100);
    ...
    private void Block()
    {
        ...
        // 만약 blockAfterNum이 1이면
        else if (blockAfterNum >= 10)
        {
    ...
    {
        // idleFinishTime을 정해주고
        idleFinishTime = UnityEngine.Random.Range(1, 3);
        // 상태를 기본으로 바꿉시다.
        state = EnemyState.Idle;
    }
}
